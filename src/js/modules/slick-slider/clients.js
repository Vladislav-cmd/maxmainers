const clientsLogoSliderBlock = document.querySelector('.cli-block__slider');

window.addEventListener('load', clientsLogoSlider);

function clientsLogoSlider() {
    $(document).ready(function () {
        $('.cli-block__slider').length && $('.cli-block__slider').not('.slick-initialized').slick({
            ...
            slidesToShow: 6, // опция, кол-во слайдов, которое показывается за раз, по умолчанию 1
