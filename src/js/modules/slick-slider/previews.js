const previewsSliderBlock = document.querySelector('.prev-block__slider');

window.addEventListener('load', documentsSlider);

function documentsSlider() {
    $(document).ready(function () {
        $('.prev-block__slider').length && $('.prev-block__slider').not('.slick-initialized').slick({
            ...
            slidesToShow: 3, // опция, кол-во слайдов, которое показывается за раз, по умолчанию 1
